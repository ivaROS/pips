...
public:
  ...
  {    
    ...
    // Also the stereo camera frame is different from the depth camera frame.
    // The stereo camera is in front of center of robot. We check the robot is not over the image plane.
